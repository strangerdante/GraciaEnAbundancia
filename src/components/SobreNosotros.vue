<template>
  <section
    class="px-4 sm:px-6 2xl:px-80 py-10 sm:py-14 transition duration-300 ease-in-out selection:bg-blue-500 selection:text-white"
    id="inicio"
  >
    <article>
      <h1
      ...
      >
        <span
          class="border-2 border-blue-600 rounded-lg text-sm px-3 py-1 flex-shrink-0 text-blue-600 dark:text-blue-white dark:border-blue-400 dark:text-white hover:bg-blue-600 hover:text-white transition duration-300 cursor-pointer"
          >Efesios 4:11-12</span
        >
        <span
          class="border-2 border-blue-600 rounded-lg text-sm px-3 py-1 flex-shrink-0 text-blue-600 dark:text-blue-white dark:border-blue-400 dark:text-white hover:bg-blue-600 hover:text-white transition duration-300 cursor-pointer"
          >Mateo 28:19-20</span
        ...
        <span
          class="border-2 border-blue-600 rounded-lg text-sm px-3 py-1 flex-shrink-0 text-blue-600 dark:text-blue-white dark:border-blue-400 dark:text-white hover:bg-blue-600 hover:text-white transition duration-300 cursor-pointer"
          >Colosenses 3:16</span
        >
        <span
          class="border-2 border-blue-600 rounded-lg text-sm px-3 py-1 flex-shrink-0 text-blue-600 dark:text-blue-white dark:border-blue-400 dark:text-white hover:bg-blue-600 hover:text-white transition duration-300 cursor-pointer"
          >Hebreos 10:24-25</span
        >
      </div>
